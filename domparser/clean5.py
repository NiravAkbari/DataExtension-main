...
# def drop_tree(el, tag_name=None, with_tail=False):
#     # print(tag_name)
#     if isinstance(el, etree._Comment):
#         tag_name = etree._Comment
#         print('Comment type')
#         return
#     etree.strip_elements(el, with_tail=False)
#
# def drop_tag(el, tag_name=[]):
#     # print(tag_name)
